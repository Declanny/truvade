...
const mockConversations: Conversation[] = [
  {
    ...
    hostName: "Amara O.",
    lastMessage: "Your check-in details have been sent. See you soon!",
  ...
  },
  {
    ...
    hostName: "Chidi E.",
    lastMessage: "Yes, parking is available for guests.",
  ...
  },
  {
    ...
    hostName: "Ngozi A.",
    lastMessage: "Thank you for staying with us! We hope you enjoyed it.",
...
const mockMessages: Record<string, ChatMessage[]> = {
  "conv-1": [
    { id: "m1", senderId: "host", content: "Hello! Thanks for booking. Let me know if you have any questions about the apartment.", timestamp: "Mar 16, 10:00 AM", isMe: false },
    { id: "m2", senderId: "me", content: "Hi! Is early check-in possible? We arrive around 10 AM.", timestamp: "Mar 16, 10:15 AM", isMe: true },
    { id: "m3", senderId: "host", content: "We can arrange check-in from 11 AM for a small fee of NGN 5,000. Would that work?", timestamp: "Mar 16, 10:30 AM", isMe: false },
    { id: "m4", senderId: "me", content: "That works perfectly, thank you!", timestamp: "Mar 16, 10:45 AM", isMe: true },
    { id: "m5", senderId: "host", content: "Great! I'll update the booking. Your check-in details have been sent. See you soon!", timestamp: "Mar 16, 11:00 AM", isMe: false },
  ],
  "conv-2": [
    { id: "m1", senderId: "me", content: "Hi, does the studio have parking space?", timestamp: "Mar 15, 2:00 PM", isMe: true },
    { id: "m2", senderId: "host", content: "Yes, parking is available for guests.", timestamp: "Mar 15, 2:30 PM", isMe: false },
  ],
  "conv-3": [
    { id: "m1", senderId: "host", content: "Welcome! Let us know if you need anything during your stay.", timestamp: "Feb 10, 3:00 PM", isMe: false },
    { id: "m2", senderId: "me", content: "Everything is perfect, thank you!", timestamp: "Feb 12, 9:00 AM", isMe: true },
    { id: "m3", senderId: "host", content: "Thank you for staying with us! We hope you enjoyed it.", timestamp: "Feb 14, 12:00 PM", isMe: false },
  ],
};
            ...
            {activeConversation ? (
              <>
                ...
                <div className="flex items-center gap-3 p-4 border-b border-gray-200">
                  ...
                  />
                  <div>
                    <p className="font-semibold text-gray-900 text-sm">{activeConversation.hostName}</p>
                    <p className="text-xs text-gray-500">{activeConversation.propertyName}</p>
                  </div>
                </div>
