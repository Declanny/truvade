...
ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', '' if not DEBUG else '*').split(',') if os.environ.get('ALLOWED_HOSTS') else (['*'] if DEBUG else [])
...
DEFAULT_FROM_EMAIL = 'noreply@truvade.com'
